...
public class ClientApplication3 {
    ...
    static void sendRequest() throws IOException {
        ...
        System.out.println("ClientApplication 3 : Connected to Client Stub");
        ...
        System.out.println("ClientApplication 3 : Sending message to Client Stub to pass :");
        out.writeBytes(msg + "\n");
        System.out.println("ClientApplication 3 : Message sent : " + msg);
    ...
    static void getResponse() throws IOException {
        result = in.readLine();
        System.out.println("");
        System.out.println("ClientApplication 3 : Got the final sorted output using : " + methodName + " : " + result);
    }
    ...
    public static void runClient() {
        ...
        try {
            ...
            System.out.println(ex + " client 3");
        }
