...
public class ClientApplication2 {
    ...
    static void sendRequest() throws IOException {
        ...
        System.out.println("ClientApplication 2 : Connected to Client Stub");
        ...
        System.out.println("ClientApplication 2 : Sending message to Client Stub to pass :");
        out.writeBytes(msg + "\n");
        System.out.println("ClientApplication 2 : Message sent : " + msg);
    ...
    static void getResponse() throws IOException {
        result = in.readLine();
        System.out.println("");
        System.out.println("ClientApplication 2 : Got the final sorted output using : " + methodName + " : " + result);
    }
    ...
    public static void runClient() {
        ...
        try {
            ...
            System.out.println(ex + " client 2");
        }
